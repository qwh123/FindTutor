package com.qwh.findtutor.ui.activity.DropMenu.view.betterDoubleGrid;
...
import com.qwh.findtutor.ui.activity.DropMenu.view.betterDoubleGrid.holder.ItemViewHolder;
import com.qwh.findtutor.ui.activity.DropMenu.view.betterDoubleGrid.holder.TitleViewHolder;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (itemViewType) {
            case TYPE_TITLE:
                ...
                if (position == 0) {
                    titleViewHolder.bind(mContext.getString(R.string.search_double_top));
                } else {
                    titleViewHolder.bind(mContext.getString(R.string.search_double_bottom));
                }
                break;
            case TYPE_ITEM:
